#ifndef SHHD_TIME_INTEGRATOR_EULER_COMPRESSIBLE_H
#define SHHD_TIME_INTEGRATOR_EULER_COMPRESSIBLE_H
...
public:
    ...
    void step(State& u, double t, const RHSOperators& rhs) override {
        ...
        rhs.rho_det(u_old_, deterministic_rhs_.rho_hat_data(), t, flux_det);
