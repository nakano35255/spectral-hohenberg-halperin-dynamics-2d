...
This directory contains Kugui PBS job helpers for a large `examples/03_2` style
run. It is the Kugui counterpart of `examples/03_2/ohtaka_large`, but the
...
```sh
qsub -v BUILD_BEFORE_RUN=1 examples/03_2/kugui_large/job_kugui_relax_D0_0p004_grid512_dt16.pbs
```
...
qsub -v REPLICA_ID=0,RELAX_SEGMENT=1 \
  examples/03_2/kugui_large/job_kugui_relax_D0_0p004_grid512_dt16.pbs
```
...
```text
/work/i0019/i001900/spectral-hohenberg-halperin-dynamics-2d/examples/03_2/kugui_large/
...
qsub -v REPLICA_ID=0,RESTART_INDEX=2 \
  examples/03_2/kugui_large/job_kugui_budget_D0_0p004_grid512_dt16.pbs
```
...
- The restart files are text files and can be large, so outputs are written
  under `/work/.../examples/03_2/kugui_large/`.
