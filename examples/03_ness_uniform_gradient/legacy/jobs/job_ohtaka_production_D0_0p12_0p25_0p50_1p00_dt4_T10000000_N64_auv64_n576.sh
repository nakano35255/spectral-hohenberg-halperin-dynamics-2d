...
run_name=production_D0_0p12_0p25_0p50_1p00_dt4_T10000000_N64_auv64_n576
output_root=$work_base/$run_name

cd "$repo"
mkdir -p "$output_root"

D0s=(0.12 0.25 0.50 1.00)
dt=4.0
samples=576
total_tasks=9216
tasks_per_sample=4
...
grid=64
length=4096
gradient_amplitude=0.000048828125
