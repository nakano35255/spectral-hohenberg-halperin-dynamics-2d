...
#SBATCH -c 1
#SBATCH -t 24:00:00
#SBATCH -J shhd02-L256-dt0005
#SBATCH -o /work/i0019/i001900/spectral-hohenberg-halperin-dynamics-2d/examples/02_Kolomogorov_flow/incompressible/instability/jobs/%x-%j.out
#SBATCH -e /work/i0019/i001900/spectral-hohenberg-halperin-dynamics-2d/examples/02_Kolomogorov_flow/incompressible/instability/jobs/%x-%j.err
...
work_base=/work/i0019/i001900/spectral-hohenberg-halperin-dynamics-2d/examples/02_Kolomogorov_flow/incompressible/instability/main
case_dir=examples/02_Kolomogorov_flow/incompressible
run_name=eta0_0.1_U0.25_dt0.005
