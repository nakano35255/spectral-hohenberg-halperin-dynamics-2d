...
def main():
    ...
    parser.add_argument("--grid", nargs=2, type=int, default=[512, 512])
    parser.add_argument("--length", nargs=2, default=["16384", "16384"])
    ...
    parser.add_argument("--gradient-amplitude", default="0.0001220703125")
