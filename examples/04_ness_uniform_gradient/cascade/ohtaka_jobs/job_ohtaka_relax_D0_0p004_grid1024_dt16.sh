...
#SBATCH -c 1
#SBATCH -t 24:00:00
#SBATCH -J shhd04-cascade-relax-D0004
#SBATCH -o /home/k0565/k056500/spectral-hohenberg-halperin-dynamics-2d/examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/%x-%j.out
#SBATCH -e /home/k0565/k056500/spectral-hohenberg-halperin-dynamics-2d/examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/%x-%j.err
...
case_dir=examples/04_ness_uniform_gradient/cascade/ohtaka_jobs
work_base=/work/k0565/k056500/spectral-hohenberg-halperin-dynamics-2d/examples/04_ness_uniform_gradient/cascade/raw_data
...
relax_time=${RELAX_TIME:-20000000.0}
