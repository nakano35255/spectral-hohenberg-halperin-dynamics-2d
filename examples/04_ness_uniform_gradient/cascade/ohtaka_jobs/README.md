...
This directory contains Ohtaka job helpers for a large `examples/04_ness_uniform_gradient/cascade` style run.
...
```sh
BUILD_BEFORE_RUN=1 sbatch examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/job_ohtaka_relax_D0_0p004_grid1024_dt16.sh
```
...
sbatch examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/job_ohtaka_relax_D0_0p004_grid1024_dt16.sh
```
...
```sh
RELAX_TIME=10000000.0 sbatch examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/job_ohtaka_relax_D0_0p004_grid1024_dt16.sh
```
...
```sh
sbatch examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/job_ohtaka_budget_D0_0p004_grid1024_dt16.sh
```

To rerun or analyze only selected replicas:

```sh
REPLICA_IDS="0 3 7" sbatch examples/04_ness_uniform_gradient/cascade/ohtaka_jobs/job_ohtaka_budget_D0_0p004_grid1024_dt16.sh
```

The restart files are text files. For this grid they can be large, so the jobs
write them under `/work/.../examples/04_ness_uniform_gradient/cascade/raw_data/`.

Output is organized by replica:

```text
/work/.../examples/04_ness_uniform_gradient/cascade/raw_data/relax_D0_0p004_grid1024_L32768_dt16/
  replica_000/
    results/
    restarts/
    runs/
