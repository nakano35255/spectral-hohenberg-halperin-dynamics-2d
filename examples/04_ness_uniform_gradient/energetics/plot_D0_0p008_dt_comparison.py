...
from analysis_common import EXAMPLE, FIGURE_DIR, parse_input, read_time_series, transform, col
...
CASES = [
    ...
    },
    {
        ...
        "result_dir": EXAMPLE / "raw_data" / "Sc1" / "D0_0.008" / "results",
        "input_path": EXAMPLE / "raw_data" / "Sc1" / "D0_0.008" / "runs" / "input_000.script",
        "color": "#2563eb",
        "linestyle": "-",
    },
]
...
def load_results():
    return {case["key"]: load_case(case) for case in CASES}
