...
| `measure correlation/static` | `measure <ID> correlation/static <on\|off> nevery <integer> nblock <integer> file <filename> mode <2d\|shell> [average <block\|running>] [cross <on\|off>] target <target1> [target2 ...]` | [詳細](./measure_correlation_static.md) |
